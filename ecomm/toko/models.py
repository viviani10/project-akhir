...
#     def __str__(self):
        # return f"{self.quantity} of {self.nama_produk}"
    # label = models.CharField(choices=PILIHAN_LABEL, max_length=4)
    # tambahkan field lain yang diperlukan untuk item
# class Item(models.Model):
#     quantity = models.IntegerField(default=1)
#     kategori = models.SlugField(max_length=100, default='C')
#     nama_produk = models.CharField(max_length=100, default='')
